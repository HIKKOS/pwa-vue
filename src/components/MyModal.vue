<template>
  ...
  >
    ...
    >
      <!-- Modal Header -->
      <div
        class="bg-purple-500 text-white px-4 py-2 flex justify-between items-center"
      >
      ...
      <div class="border-t px-4 py-2 flex justify-end">
        <button
          ...
          class="px-3 py-1 bg-purple-500 text-white rounded-md w-full sm:w-auto"
          @click="$emit('submit')"
        >
          Aceptar
        </button>
...
import { defineEmits, defineProps, defineSlots } from "vue";

defineProps<{
  title: string;
}>();
defineSlots<SlotProps>();
interface SlotProps {
  content?: string;
}
